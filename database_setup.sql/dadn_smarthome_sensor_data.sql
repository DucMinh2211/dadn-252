...
CREATE TABLE `sensor_data` (
  ...
  PRIMARY KEY (`id`),
  KEY `feed_id` (`feed_id`),
  CONSTRAINT `sensor_data_ibfk_1` FOREIGN KEY (`feed_id`) REFERENCES `feeds` (`id`) ON DELETE CASCADE
...
INSERT INTO `sensor_data` VALUES (1,1,99,'2026-03-22 17:41:08'),(2,5,100,'2026-03-22 17:41:08');
